...
import com.caozj.model.wx.group.GroupResult;
import com.caozj.model.wx.group.openid.GroupImage;
import com.caozj.model.wx.group.openid.GroupMpNews;
import com.caozj.model.wx.group.openid.GroupText;
import com.caozj.model.wx.group.openid.GroupVideo;
import com.caozj.model.wx.group.openid.GroupVoice;
 ...
 */
@Component
public class SendGroupMessageByOpenIDWxUtil {
	...
	public GroupResult send(GroupMpNews msg) {
		String url = WxConstantData.sendGroupByOpenID + "?access_token=" + accessTokenUtil.getAccessToken();
		String json = FastJsonUtil.toJson(msg);
		return postJsonUtil.postJson(url, json, "根据OpenID列表群发", GroupResult.class);
	}
