...
import com.caozj.model.wx.receive.event.VerifySuccessEvent;
import com.caozj.util.common.ParseUtil;

public class VerifySuccessEventParse implements ParseWxXML {

	@Override
	public BaseReceiveObject parse(DeferredElementImpl root) throws XPathExpressionException {
		VerifySuccessEvent event = new VerifySuccessEvent();
		...
		event.setExpiredTime(NumberUtils.toLong(ParseUtil.getValue(root, "ExpiredTime")));
		return event;
	}
